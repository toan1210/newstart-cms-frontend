...
function Index() {
  ...
  var datetime =[];
  let arrayallnews = state.allnew.reverse();
  ...
  <div className="container">
    ...
    <div className="detail-content">
      ...
      <div className="left-quangcao">
                  {
                   typeof(arrayadvertisements[0].DetailAdvertisementNewsRight[0]) !== 'undefined'?
                   <a href={arrayadvertisements.DetailAdvertisementNewsRightContent}>
                       <img className="left-quangcao-img" src={iplink + arrayadvertisements[0].DetailAdvertisementNewsRight[0].url} alt="" />
                    </a>:null
                 }
              </div> 
      </div>
