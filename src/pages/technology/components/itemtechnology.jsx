...
function Itemnew({_id,title,author,status,category,date,images,sumary}) {
  let {ip} = useAuth();
  var timedate ="";
  ...
  return(
      <>
        <div className="new-content-news">
          <a className="content-news" href={`/technology/${_id}`}>  
            ...
            <div className="content-news-text">
              ...
              <div className="news-text-time">
                ...
                <span className="time use" style={{marginLeft:5}}>{author}</span>
              </div>
